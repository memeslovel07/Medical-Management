...
{
    public partial class DatewiseSale : Form
    {
        public DatewiseSale()
        {
            InitializeComponent();
        ...
        DataTable objdt;
        private void DatewiseSale_Load(object sender, EventArgs e)
        {
        ...
        private void btnshow_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    objadt = new SqlDataAdapter("select * from Sale where Voucherdate>='" + dateTimePicker1.Text + "' and Voucherdate<='" + dateTimePicker2.Text + "'", objcon);
                }
            }
            objdt = new DataTable();
            objadt.Fill(objdt);
