...
{
    public partial class idwiseComapny : Form
    {
        public idwiseComapny()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
         ...
         else
         {
             ...
             {
                objadt = new SqlDataAdapter("select * from Company where Companyid='"+cmbmiw.Text+"'", objcon);
             }
         }
        ...
        private void Medicineidwise_Load(object sender, EventArgs e)
        {
        ...
        private void cmbmiw_Click(object sender, EventArgs e)
        {
            ...
            { 
                cmbmiw.Items.Add(dr["Companyid"].ToString());
            }
